...
init python:
    ...
    build.package(build.directory_name + "Mod",'zip',"mod_package",description='DDLC Compatible Mod')

    # Declare archives
    build.archive(build.name,"mod_package")
    build.archive("launcher","mod_package")

    #Choose files for archives
    build.classify("game/mods/mod_template/mod_assets/**",build.name)
    build.classify("game/mods/mod_template/submods/**",build.name)
    build.classify('game/mods/mod_template/**.rpyc',build.name)
    build.classify("game/mods/mod_loader/**.rpyc","launcher")
    ...
    build.classify('README.html',"mod_package")
